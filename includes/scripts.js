...
if(document.getElementById('wrongAnswer-1').checked) {
 
  count=count+1;
}
if(document.getElementById('wrongAnswer-2').checked) {
  
  count=count+1;
}
if(document.getElementById('wrongAnswer-3').checked) {
...
if(document.getElementById('wrongAnswer-4').checked) {
 
  count=count+1;
}
if(document.getElementById('wrongAnswer-5').checked) {
 
  count=count+1;
}
if(document.getElementById('wrongAnswer-6').checked) {
...
if(document.getElementById('wrongAnswer-7').checked) {
 
  count=count+1;
}
if(document.getElementById('wrongAnswer-8').checked) {
 
  count=count+1;
}
if(document.getElementById('wrongAnswer-9').checked) {
...
if(document.getElementById('wrongAnswer-10').checked) {
 
  count=count+1;
}
if(document.getElementById('wrongAnswer-11').checked) {
 
  count=count+1;
}
if(document.getElementById('wrongAnswer-12').checked) {
...
if(document.getElementById('wrongAnswer-13').checked) {
 
  count=count+1;
}
if(document.getElementById('wrongAnswer-14').checked) {
 
  count=count+1;
}
if(document.getElementById('wrongAnswer-15').checked) {
